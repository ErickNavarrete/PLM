...
{
    public partial class ConsultaBom : MetroForm
    {
        ...
        {
            DataTable[] dtBoms = Bom.ExportarDatos(DtBOM, txtNroBom.Text, txtEstilo.Text);
            ...
            if(dtBoms != null)
            {
                ...
                Reporte.vistaReporte viewReport = new Reporte.vistaReporte(1);
